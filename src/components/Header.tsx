        ...
        <div className="max-w-screen-2xl mx-auto px-6 flex items-center h-20 gap-6">
          ...
          <div className="hidden sm:flex items-center gap-2">
            {[
              ...
              { label: "MAX", url: "https://max.ru/join/P_HfSBqoL1_EzOFrrv_IeuUQ7u55zTDXVB0p-ODUk6E", color: "#7B3FE4", icon: <img src="https://cdn.poehali.dev/projects/0589c48d-6b6a-42bf-a296-e4c2f31df20b/bucket/8c98bbd7-2d26-4d5b-8f87-15aa0670acf0.png" alt="MAX" width="18" height="18" className="rounded-sm" /> },
            ].map((s) => (
              <a
                key={s.label}
                href={s.url}
